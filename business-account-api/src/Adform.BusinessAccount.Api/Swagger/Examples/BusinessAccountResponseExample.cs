...
{
	public class BusinessAccountResponseExample : IExamplesProvider<Contracts.Entities.BusinessAccount>
	{
		public Contracts.Entities.BusinessAccount GetExamples()
		{
			return new Contracts.Entities.BusinessAccount
			{
				Id = Guid.NewGuid(),
				Name = "Tenant",
